...
## Checklist de notation (usage formateur)

> Ne pas publier dans Simplonline — usage interne pour la correction.

```
Apprenant : _______________  Date : _______________
Repo GitHub : _________________________________ (public / prive)

--- C2. Cartographier les donnees disponibles — Niveau 3 (Transposer) ---
[ ] Sources de donnees identifiees et documentees
[ ] Qualite des donnees evaluee (valeurs manquantes, doublons, incoherences)
[ ] Relations entre les entites identifiees
[ ] Cartographie formalisee dans un livrable exploitable
[ ] Code versionne et accessible sur le repo GitHub public
[ ] README present et complet
Observation : _________________________________
Score : ___/6

--- C3. Concevoir un cadre technique — Niveau 3 (Transposer) ---
[ ] Docker Compose fonctionnel avec PostgreSQL
[ ] Volume persistant configure
[ ] Choix de version PostgreSQL justifie
...
--- C9. Developper des requetes SQL — Niveau 3 (Transposer) ---
[ ] Jointures multi-tables fonctionnelles (INNER, LEFT, FULL)
[ ] Agregations avec GROUP BY et HAVING
[ ] CTE utilisees a bon escient
[ ] Fonctions fenetres implementees (ROW_NUMBER, RANK, LAG/LEAD)
[ ] Sous-requetes maitrisees
[ ] Plans d'execution analyses avec EXPLAIN ANALYZE
[ ] Code versionne et accessible sur le repo GitHub public
Observation : _________________________________
Score : ___/7

--- C10. Developper des regles d'agregation — Niveau 3 (Transposer) ---
[ ] Donnees chargees depuis les CSV sans perte
[ ] Doublons identifies et traites
[ ] Formats homogeneises (dates, adresses, statuts)
[ ] Entrees corrompues supprimees ou corrigees
[ ] Code versionne et accessible sur le repo GitHub public
Observation : _________________________________
Score : ___/5

--- C11. Creer une base de donnees — Niveau 3 (Transposer) ---
[ ] Modele de donnees formalise (MCD ou MLD)
[ ] Tables creees avec contraintes PK et FK
[ ] Contraintes CHECK et UNIQUE pertinentes appliquees
[ ] Types de donnees appropries pour chaque colonne
[ ] Vues creees pour au moins 3 cas d'usage metier
[ ] Indexes crees avec justification
[ ] Partitionnement implemente sur au moins 1 table
[ ] CLUSTER execute avec impact mesure
[ ] Code versionne et accessible sur le repo GitHub public
Observation : _________________________________
Score : ___/9
...
--- C16. Gerer l'entrepot de donnees — Niveau 3 (Transposer) ---
[ ] Sauvegarde pg_dump fonctionnelle
[ ] Restauration testee et documentee
[ ] Transfert rsync operationnel
[ ] Strategie de sauvegarde justifiee
[ ] Performance mesuree avant/apres optimisations (captures EXPLAIN)
[ ] Code versionne et accessible sur le repo GitHub public
Observation : _________________________________
Score : ___/6

RESULTAT GLOBAL : ___/6 competences validees
```
